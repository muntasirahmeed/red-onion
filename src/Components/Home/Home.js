    ...
    <div className="">
      ...
      {/* <div className="home  flex flex-col justify-center items-center">
        ...
        <div className="md:mb-28 lg:mb-0 xl:mb-0">
          <input
            type="text"
            className="bg-gray-100 w-8/12  md:w-12/12 mx-auto focus:outline-none h-10   rounded-tl-full rounded-bl-full px-4 font-semibold input-element font-poppins text-sm "
            placeholder=" Search Food"
          />
          <button className="bg-rose-600 text-white py-2 px-6   hover:bg-rose-700 duration-300 font-semibold ease-in-out button-element text-sm ring-2  ring-gray-300 ring-offset-2 rounded-full md:transl rounded-tr-full  rounded-br-full">
            Search
          </button>
        </div>
      </div> */}
