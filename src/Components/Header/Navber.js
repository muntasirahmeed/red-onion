    ...
    <nav className="max-w-[1280px] mx-auto  bg-gray-100 w-full top-0 left-0">
      <div className="flex items-center justify-between py-4 md:px-10 px-7">
        ...
        >
          ...
          <span className="block font-semibold text-lg text-gray-600 ">Login</span>
          <button className="bg-rose-700 text-white py-2 px-6 rounded-full  hover:bg-rose-700 duration-300 font-semibold ease-in-out">
            Sign Up
          </button>
